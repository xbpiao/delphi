...
{                                                       }
{*******************************************************}
// 从XE2的版本中修改来而，发现保存文件有问题初步估计是.obj不匹配导致
// 加载显示没问题
// Program Files\Embarcadero\RAD Studio\9.0\source\vcl\Vcl.Imaging.jpeg.pas
...
function TJPEGImage.JPEGFileSize: Int64;
begin
  Result := 0;
  if (FImage <> nil) and (FImage.FData <> nil) then
  begin
    Result := FImage.FData.Size;
  end;// if
end;
